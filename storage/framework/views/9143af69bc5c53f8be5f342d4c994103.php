...
<body>
    ...
    <div class="container">
        <img src="<?php echo e(asset('images/7-Eleven-Logo.png')); ?>" alt="Logo de 7-Eleven" class="logo">
        <h1>Bienvenido a 7-Eleven</h1>
        <p>¡La tienda conveniente para tus necesidades!</p>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\xampp\_pointlcr.shop (1)\resources\views/inicio/index.blade.php ENDPATH**/ ?>